        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2">
              <li>
                <Link href="/webinars" className="text-gray-500 hover:text-gray-700">
                  Webinars
                </Link>
              </li>
              <li>
              ...
              {webinar.categories && webinar.categories.length > 0 && (
                <>
                  <li>
                    <span className="text-gray-500">{webinar.categories[0]}</span>
                  </li>
                  <li>
                    <svg className="w-4 h-4 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mb-8 relative">
                ...
                <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-lg px-4 py-2 shadow-lg">
                  <div className="text-center">
                    <div className="font-semibold text-gray-900">{formatDate(webinar.scheduledDate)}</div>
                    <div className="text-sm text-gray-600">{format(new Date(webinar.scheduledDate), 'h:mm a')}</div>
                    <div className="text-xs text-gray-500">{webinar.duration} min</div>
                  </div>
                </div>
              </div>
              ...
              {webinar.guestSpeakers && webinar.guestSpeakers.length > 0 && (
                <div className="mb-8">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Guest Speakers</h3>
              ...
              {webinar.materials && webinar.materials.length > 0 && (
                <div className="mb-8">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Discussion Resources</h3>
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6 sticky top-6">
                ...
                <div className="mb-6">
                  <div className="flex items-center text-sm text-gray-600 mb-2">
                    ...
                    <span>{format(new Date(webinar.scheduledDate), 'EEEE, MMM d, yyyy')}</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 mb-2">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <div className="space-y-3">
              <button
                onClick={() => {
                  window.open(`https://nextdoor.com/share?text=${encodeURIComponent(webinar.title)}&url=${encodeURIComponent(window.location.href)}`, '_blank')
              ...
              <button
                onClick={() => {
                  window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(webinar.title)}&url=${encodeURIComponent(window.location.href)}`, '_blank')
                  setShowShareModal(false)
                }}
                className="w-full flex items-center p-3 hover:bg-gray-50 rounded-lg transition-colors"
              >
              ...
              <button
                onClick={() => {
                  window.open(`mailto:?subject=${encodeURIComponent(webinar.title)}&body=${encodeURIComponent(`Check out this webinar: ${window.location.href}`)}`)
                  setShowShareModal(false)
                }}
                className="w-full flex items-center p-3 hover:bg-gray-50 rounded-lg transition-colors"
              >
