  ...
  return (
    <div className='min-h-screen bg-gray-50'>
          ...
          <div className='flex justify-between items-center py-6'>
            <div>
              ...
              <p className='mt-1 text-sm text-gray-500'>
                Advanced search and filtering for webinars - {webinars.length}{' '}
                results
              </p>
            </div>
            <Link
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        {/* Search and Filters */}
        <AdminSearchFilters type='webinars' onSearch={handleSearch} />
                  ...
                  >
                    <div className='p-4'>
                      <div className='flex items-center justify-between mb-2'>
                        <span
                          className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(webinar.status)}`}
                        >
                          {webinar.status}
                        </span>
                        <span className='text-sm text-gray-500'>
                          {webinar.rsvpCount} RSVPs
                        </span>
                      </div>
                      ...
                      <div className='space-y-1 text-sm text-gray-500'>
                        ...
                        <p>
                          <strong>Created by:</strong> {webinar.createdBy}
                        </p>
                      </div>
