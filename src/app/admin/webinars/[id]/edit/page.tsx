  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const requestData = {
        ...
        categories: formData.categories.split(',').map(t => t.trim()).filter(t => t),
      ...
      setError('An error occurred while updating the webinar: ' + error.message)
    } finally {
      setSaving(false)
    }
  }
            ...
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 break-all">{urlPreview}</p>
                </div>
