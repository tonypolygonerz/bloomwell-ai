                  ...
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      >
                        <div className="flex items-center">
                          Organization
                          {(searchParams.sortBy || 'createdAt') === 'organization' && (
                            <span className="ml-1">
                              {(searchParams.sortOrder || 'desc') === 'asc' ? '↑' : '↓'}
                            </span>
                          )}
                      ...
                      >
                        <div className="flex items-center">
                          Account Type
                          {(searchParams.sortBy || 'createdAt') === 'accountType' && (
                            <span className="ml-1">
                              {(searchParams.sortOrder || 'desc') === 'asc' ? '↑' : '↓'}
                            </span>
                          )}
                      ...
                      >
                        <div className="flex items-center">
                          Last Login
                          {(searchParams.sortBy || 'createdAt') === 'lastLogin' && (
                            <span className="ml-1">
                              {(searchParams.sortOrder || 'desc') === 'asc' ? '↑' : '↓'}
                            </span>
                          )}
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          {user.organization && (
                            <div className="text-sm text-gray-500">
                              {user.organization.staffSize} • {user.organization.budget}
                            </div>
                          )}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
