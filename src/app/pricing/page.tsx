...
export const metadata = {
  ...
  description: 'Professional grant discovery tools for nonprofits under $3M budget. Start your 14-day free trial with no credit card required.',
  keywords: 'nonprofit pricing, grant writing tools, AI assistant, webinar access, transparent pricing',
};
      ...
      <section className="relative py-20 bg-gradient-to-br from-gray-50 to-white overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="block font-semibold text-green-600">One plan, unlimited possibilities.</span>
          </p>
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-emerald-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
            Join hundreds of nonprofits already securing funding with Bloomwell AI
          </p>
          <Link
            href="/auth/register"
