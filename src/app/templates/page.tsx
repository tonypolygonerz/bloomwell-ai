...
export default function TemplateDashboard() {
  ...
  const [dashboardData, setDashboardData] =
    useState<TemplateDashboardData | null>(null);
  ...
  const filteredTemplates =
    dashboardData?.availableTemplates.filter(template => {
      const categoryMatch =
      ...
      <div className='min-h-screen bg-gray-50 flex items-center justify-center'>
        <div className='text-center'>
          ...
          <p className='mt-4 text-gray-600'>
            Loading your template dashboard...
          </p>
        </div>
      </div>
    );
      ...
      <div className='min-h-screen bg-gray-50 flex items-center justify-center'>
        <div className='text-center'>
          ...
          <p className='text-gray-600'>
            Unable to load template dashboard data.
          </p>
        </div>
      </div>
    );
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='mt-2 text-gray-600'>
                Discover and start guided workflows tailored to your nonprofit
                needs
              </p>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
              <div className='bg-white rounded-lg p-4 shadow-sm'>
                ...
                <div className='text-lg font-semibold text-gray-900'>
                  {dashboardData.userIntelligence.userProfile.focusAreas
                    ?.length || 0}
                </div>
              </div>
              <div className='bg-white rounded-lg p-4 shadow-sm'>
              ...
              <div className='bg-white rounded-lg p-4 shadow-sm'>
                ...
                <div className='text-lg font-semibold text-gray-900'>
                  {formatTime(
                    dashboardData.userIntelligence.averageCompletionTime
                  )}
                </div>
              </div>
              <div className='bg-white rounded-lg p-4 shadow-sm'>
                ...
                <div className='text-lg font-semibold text-gray-900 capitalize'>
                  {dashboardData.userIntelligence.learningStyle.replace(
                    '_',
                    ' '
                  )}
                </div>
