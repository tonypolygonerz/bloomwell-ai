...
export const metadata: Metadata = {
  ...
  description: 'Expert-led webinar sessions to help your nonprofit organization thrive. Learn from industry leaders and connect with peers in grant writing, board governance, fundraising, and more.',
  keywords: 'webinar, nonprofit, training, education, grant writing, board governance, fundraising, operations, strategic planning',
  authors: [{ name: 'Bloomwell AI' }],
  creator: 'Bloomwell AI',
  publisher: 'Bloomwell AI',
  openGraph: {
    title: 'Upcoming Webinars for Nonprofit Leaders',
    description: 'Expert-led sessions to help your organization thrive. Learn from industry leaders and connect with peers.',
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6 sticky top-6">
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-gray-900">September 2025</h3>
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-gray-900">Your next events</h3>
                ...
                {webinars.length > 0 ? (
                  <div className="space-y-3">
                    {webinars.slice(0, 3).map((webinar) => (
                      <div key={webinar.id} className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                        <div className="flex-1 min-w-0">
                          <p className="text-xs text-gray-500 uppercase tracking-wide">
                            {new Date(webinar.scheduledDate).toLocaleDateString('en-US', { 
                              weekday: 'short', 
                              month: 'short', 
                              day: 'numeric' 
                            })} - {new Date(webinar.scheduledDate).toLocaleTimeString('en-US', { 
                              hour: 'numeric', 
                              minute: '2-digit',
                              hour12: true 
                            })}
          ...
          <div className="lg:col-span-3">
            {webinars.length === 0 ? (
              <div className="bg-white rounded-lg shadow-sm border p-12 text-center">
                ...
                <p className="text-gray-500">Check back soon for upcoming webinars.</p>
              </div>
            ) : (
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-500 mb-2">
                {formatDate(webinar.scheduledDate)} - {formatTime(webinar.scheduledDate)} PDT
              </p>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <div className="flex -space-x-1">
                    {webinar.guestSpeakers.slice(0, 3).map((speaker: any, index: number) => (
                      <div
                        key={index}
