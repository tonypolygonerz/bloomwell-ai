    ...
    <div className="bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow duration-200">
      ...
      <div className="relative">
        ...
        <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-lg px-3 py-1 text-sm font-medium text-gray-900">
          <div className="text-center">
            <div className="font-semibold">{formatDate(webinar.scheduledDate)}</div>
            <div className="text-xs text-gray-600">{formatTime(webinar.scheduledDate)}</div>
          </div>
        </div>
      </div>
        ...
        {webinar.guestSpeakers && webinar.guestSpeakers.length > 0 && (
          <div className="mb-4">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-sm font-medium text-gray-700">Guest Speakers</span>
            </div>
