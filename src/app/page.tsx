        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-4xl mx-auto leading-relaxed">
              Access 73,000+ federal grants, get expert AI guidance, and join live webinars
              <span className="block font-semibold text-green-600">all for $29.99/month</span>
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center group hover:transform hover:-translate-y-2 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">73,000+ Federal Grants</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Comprehensive database of federal grants with AI-powered matching to find the perfect funding opportunities for your organization's mission and programs.
              </p>
              <Link href="/chat?prompt=find-grants" className="text-green-600 hover:text-green-700 font-semibold">
                Learn More →
              </Link>
            </div>
            ...
            <div className="text-center group hover:transform hover:-translate-y-2 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Expert AI Assistant</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Get instant answers to grant writing questions, board governance advice, and nonprofit management guidance from our specialized AI trained on nonprofit best practices.
              </p>
              <Link href="/chat" className="text-green-600 hover:text-green-700 font-semibold">
                Try Chat →
              </Link>
            </div>
            ...
            <div className="text-center group hover:transform hover:-translate-y-2 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Live Expert Webinars</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Join monthly webinars led by nonprofit experts covering grant writing, board development, fundraising strategies, and operational best practices.
              </p>
              <Link href="/webinars" className="text-green-600 hover:text-green-700 font-semibold">
                Browse Webinars →
              </Link>
            </div>
          </div>
