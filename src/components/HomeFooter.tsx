      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-16 max-w-2xl mx-auto">
            Join hundreds of organizations already using Bloomwell AI to secure more funding
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 mb-6 italic">
                "Bloomwell AI helped us identify 15 new grant opportunities we never would have found. 
                The AI assistant provided invaluable guidance for our proposal writing."
              </p>
              <div className="font-semibold text-gray-900">Sarah Johnson</div>
              <div className="text-sm text-gray-500">Executive Director, Community Health Alliance</div>
            </div>

            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="text-4xl mb-4">⭐</div>
              <p className="text-gray-600 mb-6 italic">
                "The webinar series on board governance transformed our organization. 
                We implemented the strategies immediately and saw results within months."
              </p>
              <div className="font-semibold text-gray-900">Michael Chen</div>
              <div className="text-sm text-gray-500">Board President, Youth Development Center</div>
            </div>

            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="text-4xl mb-4">⭐</div>
              <p className="text-gray-600 mb-6 italic">
                "At $29.99/month, Bloomwell AI pays for itself with just one successful grant application. 
                The ROI has been incredible for our small nonprofit."
              </p>
              <div className="font-semibold text-gray-900">Lisa Rodriguez</div>
              <div className="text-sm text-gray-500">Development Director, Arts for All</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-emerald-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl text-green-100 mb-8">
            Join hundreds of nonprofits already using Bloomwell AI to discover grants, 
            get expert guidance, and grow their impact.
          </p>
          <Link
            href="/auth/register"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/chat" className="text-gray-300 hover:text-white transition-colors">Grant Database</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#contact" className="text-gray-300 hover:text-white transition-colors">Contact Form</Link></li>
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">Get the latest nonprofit insights and updates</p>
              ...
              <p className="text-xs text-gray-400 mt-2">Future Beehiiv integration</p>
            </div>
          </div>
