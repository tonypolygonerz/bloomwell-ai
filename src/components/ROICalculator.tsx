  ...
  return (
    <div className="text-center">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 max-w-2xl mx-auto">
        <div className="mb-8">
          <label htmlFor="grant-amount" className="block text-lg font-medium text-gray-700 mb-4">
        ...
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-8 mb-6">
          ...
          <div className="text-lg text-gray-700 mb-4">return on annual investment</div>
          <div className="text-sm text-gray-600">
            One grant typically covers {Math.round(grantAmount / annualCost)} months of Bloomwell AI
          </div>
        </div>
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          <p className="text-sm text-blue-800">
            <strong>Real example:</strong> A $25,000 grant provides a 99x return on your annual Bloomwell AI investment. 
            Most nonprofits secure multiple grants per year, making the ROI even more significant.
          </p>
        </div>
      </div>
    </div>
