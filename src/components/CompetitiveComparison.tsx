  ...
  return (
    <div className="text-center">
      ...
      <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
        See how our AI-powered platform compares to traditional consulting services
      </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="p-8">
            ...
            <div className="mt-8 p-4 bg-green-50 rounded-lg">
              <p className="text-sm text-green-800 font-medium">
                ✓ Unlimited access • ✓ No additional fees • ✓ AI-powered efficiency
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border-2 border-gray-200 overflow-hidden">
          <div className="bg-gradient-to-r from-gray-600 to-gray-700 px-8 py-6">
            <h3 className="text-2xl font-bold text-white mb-2">Traditional Consultants</h3>
          ...
          <div className="p-8">
            ...
            <div className="mt-8 p-4 bg-red-50 rounded-lg">
              <p className="text-sm text-red-800 font-medium">
                ⚠ Limited hours • ⚠ Additional costs • ⚠ Scheduling constraints
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mt-12 bg-gradient-to-r from-green-100 to-emerald-100 rounded-2xl p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          ...
          <div>
            ...
            <div className="text-gray-700">Always available, no scheduling needed</div>
          </div>
          <div>
            <div className="text-3xl font-bold text-green-600 mb-2">Unlimited</div>
            <div className="text-gray-700">Projects and consultations included</div>
          </div>
        </div>
      </div>
    </div>
