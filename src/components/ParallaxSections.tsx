          ...
          <div className="order-2 lg:order-1 animate-slide-in-left">
            <div className="bg-white p-8 rounded-3xl shadow-2xl">
              <div className="text-6xl font-bold text-green-600 mb-4">
                <span className="counter" data-target="73582">0</span>
              </div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Our AI-powered system continuously updates our database with the latest federal grant opportunities. 
                Advanced filtering and matching algorithms help you find grants that align perfectly with your 
                organization's mission, programs, and funding needs.
              </p>
              <Link
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="bg-green-100 p-3 rounded-lg ml-8">
                      <p className="text-sm text-gray-700">How do I write a compelling grant proposal?</p>
                    </div>
                    <div className="bg-white border p-3 rounded-lg">
                      <p className="text-sm text-gray-700">Here are the key elements of a successful grant proposal...</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="order-2 animate-slide-in-right">
            <div className="bg-white p-8 rounded-3xl shadow-2xl">
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Our specialized AI assistant is trained on nonprofit best practices, grant writing guidelines, 
                and board governance principles. Get instant, accurate answers to your questions about 
                fundraising, compliance, program development, and more.
              </p>
              <Link
                href="/chat"
                className="inline-flex items-center bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-xl font-semibold transition-colors"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          <div className="order-2 lg:order-1 animate-slide-in-left">
            <div className="bg-white p-8 rounded-3xl shadow-2xl">
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Join our monthly webinars featuring nonprofit leaders, grant writing experts, and industry 
                professionals. Each session includes actionable insights, templates, and resources you can 
