          ...
          <div className='border-t border-gray-200 pt-6'>
            ...
            <div>
              <OrganizationSearchField
                ...
                onChange={value =>
                  setFormData({ ...formData, organizationQuery: value })
                }
          ...
          <div className='border-t border-gray-200 pt-6'>
            ...
            <div className='mb-5'>
              ...
              <select
                ...
                onChange={e =>
                  setFormData({ ...formData, has501c3Status: e.target.value })
                }
                className={`block w-full px-3 py-2.5 border ${
            ...
            <div className='mb-5'>
              ...
              <select
                ...
                onChange={e =>
                  setFormData({ ...formData, operatingRevenue: e.target.value })
                }
                className={`block w-full px-3 py-2.5 border ${
            ...
            <div className='mb-5'>
              ...
              <select
                ...
                onChange={e =>
                  setFormData({ ...formData, grantHistory: e.target.value })
                }
                className={`block w-full px-3 py-2.5 border ${
