...
const templates = [
  {
    ...
    content: 'Don\'t forget! Your webinar "{webinar_title}" is tomorrow at {webinar_time}. We look forward to seeing you there!',
  ...
  },
  {
    ...
    content: 'Thank you for attending "{webinar_title}". The recording will be available soon. We hope you found it valuable!',
